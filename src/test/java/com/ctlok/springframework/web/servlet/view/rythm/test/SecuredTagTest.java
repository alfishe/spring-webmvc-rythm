...
public class SecuredTagTest extends WebBaseTest {
    ...
    public void adminTest() throws Exception{
        this.loginAsAdmin();
        assertEquals("admin content", this.renderTemplate("secured_admin", null));
    }
    
    @Test
    public void userTest() throws Exception{
        this.loginAsUser();
        assertEquals("user content", this.renderTemplate("secured_user", null));
    }
    
    @Test
    public void anonymousTest() throws Exception{
        this.loginAsAnonymous();
        assertEquals("anonymous content", this.renderTemplate("secured_anonymous", null));
    }
    ...
    public void userGetAdminContentTest() throws Exception{
        this.loginAsUser();
        assertEquals("", this.renderTemplate("secured_admin", null));
    }
